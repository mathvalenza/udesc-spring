...
public class PropostaControllerTest {
	...
	public void setup() {
		...
		Cliente cliente = Cliente.builder().nascimento(new Date(2000-1900, 10, 10))
				.cpf("12345678911")
				.build();
...
//	@Test
//	public void calculaPropsotaVOPeloController() {
//		float valor = propostaController.getOrcamento(propostaVO);
//		
//		Assert.assertEquals(500, valor, 500);
//	}
}
